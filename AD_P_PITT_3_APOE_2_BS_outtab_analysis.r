...
#Load R data
load("/lustre/projects/Research_Project-MRC164847/Luke_W/APOE_methylation/APOE_meta_analysis/New_QC/EPIC_IDATS/AD+P_PITT/AD+P_PITT_PFC/4_analysis/results/APOE_2_with_Braak_EWASout.rdat")
...
write.csv(outtab_merged_df, "APOE_2_BS_outtab_with_manifest_info.csv", row.names = TRUE)
...
APOE2_BS_1_copy_nominally_sig_sites <- outtab_merged_df[outtab_merged_df$Number_of_2_alleles1_P < 0.05, ]

# Print and save
print(APOE2_BS_1_copy_nominally_sig_sites)
write.csv(APOE2_BS_1_copy_nominally_sig_sites, "APOE2_BS_1_copy_nominally_sig_sites.csv", row.names = FALSE)
...
APOE2_BS_1_copy_bonferroni_sig_sites <- outtab_merged_df[outtab_merged_df$Number_of_2_alleles1_P < bonferroni_threshold, ]

# Print and save
print(APOE2_BS_1_copy_bonferroni_sig_sites)
write.csv(APOE2_BS_1_copy_bonferroni_sig_sites, "APOE2_BS_1_copy_bonferroni_sig_sites.csv", row.names = FALSE)
